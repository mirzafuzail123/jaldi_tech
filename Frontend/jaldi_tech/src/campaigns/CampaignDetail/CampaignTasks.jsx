...
export default function CampaignTasks() {
    ...
    const { SingleCampaignData, CampaignTaskListFunc } = useContext(BackendContext)
    const [CampaignTaskData, setCampaignTaskData] = useState([])
    ...
    useEffect(() => {
        CampaignTaskListFunc(SingleCampaignData.id).then((data) => {
            setCampaignTaskData(data)
            setloading(false)
        })
    }, [])
                            ...
                            <div className="relative ">
                                <table className="w-full text-sm text-left text-gray-500">
                                    ...
                                    <tbody className='space-y-3 '>
                                        {CampaignTaskData.map((task, index) => {
                                            return (
